...
// v5 Generated 2017-07-13 13:20:51 +0000
...
(function () {
    ...
    (function (exports) {
        ...
        function debug(e, template, line, file) {
            file = file || "<template>";
            var lines = template.split("\n"), start = Math.max(line - 3, 0), end = Math.min(lines.length, line + 3),
    ...
    (function () {
        ...
        this.BIS = {
            $: function (t, e) {
            ...
            }(this), urlIsProductPage: function (t) {
                ...
                var n, i, r, o, s, a;
                if (null == e && (e = {}), r = BIS.extend({method: "GET"}, e), s = new XMLHttpRequest, i = new BIS.Promise, s.onreadystatechange = function () {
                ...
                try {
                    ...
                    }, BIS.request(r, {method: "POST", data: BIS.toQueryString(e)})
                }
            }, helpers: {
                ...
                if (t = t || window.event, o = t.target || t.srcElement, null != (a = o.className) && "function" == typeof a.match ? a.match(/BIS_trigger/) : void 0) {
                    ...
                    return e = (null != i ? i.handle : void 0) || t.target.getAttribute("data-product-handle"), n = this.popovers[e] || (this.popovers[e] = BIS.createPopover({
                        ...
                        return BIS.defer(13, function () {
                            return n.form.show({variantId: s})
                        })
                    })
                }
            }, create: function (t, e, n, i) {
                return null == n && (n = ""), null == i && (i = {}), null == this._base && (this._base = new BIS.Base, this._base.onError = function () {
        ...
        BIS.Base = function () {
            function e(t) {
                ...
                }, t), this._variantsByTitle = {}, this._variantsById = {}, this.productHandle = this.settings.productHandle, this.product = this.settings.product, this.ajaxOpts = {url: "//" + t.app_hostname + "/stock_notification/create.json"}
            }
            ...
            return e.prototype.variantIsUnavailable = function (e) {
                ...
                var r, o;
                return null == n && (n = this.product.id), null == i && (i = {}), BIS.extend(this.ajaxOpts, {key: "callback"}), o = {
                    email: t,
                    product_no: n,
        ...
        BIS.Button = function () {
            ...
            return e.prototype.render = function () {
                ...
                var e;
                return e = this.elm.getAttribute("data-variant-id"), BIS.preventDefault(t), t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, this.delegate.isOpen ? this.delegate.hide() : this.delegate.show({variantId: e})
        ...
        BIS.Form = function () {
            function n(e, n) {
                ...
                BIS.defer(10, function (t) {
                    return function () {
                        var e;
                        return e = BIS.extend({quantity_field_enabled: t.popover.settings.quantity_field_enabled}, t.popover.settings.labels), t.render(t.popover.product, e)
                    }
            ...
            return n.prototype.ACTIVE_CLASS_NAME = "bis-popover-active", n.prototype.frameDoc = function () {
                ...
                var e, n, i, r, o, s;
                if (null != t)for (t = parseInt(t, 10), i = BIS.$("#variants", this.frameDoc()), s = i.options, e = r = 0, o = s.length; o > r; e = ++r)if (n = s[e], parseInt(n.value, 10) === t)return i.selectedIndex = e
                ...
                return s = BIS.extend({}, e, BIS.helpers, {
                    product: BIS.extend(t, {variants: this.popover.variants}),
                ...
                var n;
                return null == e && (e = "#message_holder"), n = BIS.$(e, this.frameDoc()), this.submitButton().removeAttribute("disabled"), n.innerHTML = t && t.length > 0 ? Mustache.render('<p class="alert alert-danger">{{message}}</p>', {message: t}) : ""
        ...
        BIS.Popover = function (e) {
            function i(e) {
                var n, r, o;
                null == e && (e = BIS.Config), this.toggle = t(this.toggle, this), this.createUI = t(this.createUI, this), this.triggerHandler = t(this.triggerHandler, this), this.variantChanged = t(this.variantChanged, this), n = {trigger: "BIS_trigger"}, this.settings = BIS.extend(n, e), i.__super__.constructor.call(this, this.settings), this.settings.trigger && BIS.on(document, "click", this.triggerHandler), this.getProducts().then(function (t) {
                    return function () {
                        return t.createUI()
                    }
    ...
    BIS.Config = {
        ...
        "popup_theme": {
            ...
            "text_color": "#333333",
            "button_background_color": "#c6ab76",
        ...
        "button": {
            "use_image": false,
            "caption": "JOIN THE WAITING LIST",
            "font_size": 16,
            "bold": true,
            "position": "right-top",
            "corner_offset": 100,
            "background_color": "#c6ab76",
            "text_color": "#FFFFFF",
            "border_color": "#c6ab76",
            "border_width": 1,
            "border_radius": 0,
            "image": "//static.backinstock.org/assets/widget/notify-btn-vertical-f46bd7ac1b51e7d3c6a766d843fe60b46f8628e13e717124d83ffe65be466f4d.png",
            "visible": true
        },
        ...
        "partials": {"accepts_marketing": "\u003cdiv class='customer checkbox accepts_marketing'\u003e\u003cp\u003e\u003cinput checked id='customer_accepts_marketing' name='accepts_marketing' type='checkbox' value='1'\u003e\u003clabel for='customer_accepts_marketing'\u003eSign up for the Noble Outfitters Newsletter\u003c/label\u003e\u003c/p\u003e\u003c/div\u003e"}
    };
    BIS.Config.multivariantDropdownContainer = document;
    BIS.Config.shop = 'noble-equine.myshopify.com';
    ...
    (function () {
        ...
        e = window.BIS || {}, e.Analytics = {
            ...
            init: function () {
                return this.identify(), null != window.location.pathname.match(/^\/cart/) ? this.trackCart() : void 0
            },
            createCookie: function (e, t, n) {
                var i, o;
                return n ? (i = new Date, i.setTime(i.getTime() + 24 * n * 60 * 60 * 1e3), o = "; expires=" + i.toGMTString()) : o = "", document.cookie = "" + encodeURIComponent(e) + "=" + t + o + "; path=/;"
            },
            ...
            trackCart: function () {
                var t;
                return t = this.getCookie(this.key), null != t ? e.request("/cart.json").then(function (n, i) {
                    var o;
                    return o = JSON.parse(i), o.token ? e.Analytics.track("cart", {
                        identifier: o.token,
                        bis_id: t
                    }) : void 0
                }) : void 0
            ...
            track: function (t, n) {
                var i, o, r;
                return n = e.extend({name: t, shop_name: e.Config.shop}, n), o = function () {
                    var e;
                    e = [];
                    for (i in n)r = n[i], e.push("" + i + "=" + r);
                    return e
